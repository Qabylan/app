# попрактикуйся и создай свое приложение здесь!
...
#список вопросов
questions_list = []
questions_list.append(Question('В каком году Казахстан получила независимость?', '1991', '1986', '1993', '1989'))
questions_list.append(Question('Форма правления Республики Казахстан?', 'президентская республика', 'парламентская республика', 'конституционная монархия', 'смешанная республика'))
questions_list.append(Question('Столица Австралии', 'Канберра', 'Сидней', 'Мельбурн', 'Кейптаун'))
questions_list.append(Question('Год основания Казахского ханства?', '1465', '1337', '1228', '1667'))
